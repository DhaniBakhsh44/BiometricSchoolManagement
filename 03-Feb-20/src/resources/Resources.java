...
public class Resources {
    public static void setComboToField(JTextField field,JComboBox[] combo){
        if(combo.length>1)
            field.setText(combo[0].getSelectedItem()+"-"+combo[1].getSelectedItem()+"-"+combo[2].getSelectedItem());
        else
            field.setText(combo[0].getSelectedItem()+"");
    }//End of setComboToField method
    
    public static void setCurrentDate(JComboBox[] combo){
        java.util.Date date=new java.util.Date();
        
        combo[0].setSelectedIndex(date.getDate()-1);
        combo[1].setSelectedIndex(date.getMonth());
        System.out.println(date.getYear()+1900);
        combo[2].setSelectedItem((date.getYear()+1900+""));
                    ...
                    if(textField.isEnabled() && !f.getName().toLowerCase().contains("search") && 
                        ...
                        textField.addFocusListener(new java.awt.event.FocusAdapter() {
                            public void focusLost(java.awt.event.FocusEvent fe){
                              ...
                              if(text.trim().equals("")){
                                textField.removeAll();
                                setImage("icons/alert.png", textField);
    ...
    public static void getSelectAllList(javax.swing.JCheckBox selectCheckBox,javax.swing.JList<Object> List){    
